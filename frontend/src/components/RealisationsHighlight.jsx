...
export default function RealisationsHighlight() {
  ...
  return (
    <section id="realisations" className="py-16 sm:py-20 md:py-[120px] bg-white">
      <div className="max-w-container mx-auto px-5 md:px-8">
        <header className="mb-10 md:mb-14 flex flex-col md:flex-row md:items-end md:justify-between gap-5 md:gap-10">
          <div className="max-w-prose">
            ...
            <h2 className="font-display font-extrabold text-ink-1 m-0 mb-4 text-h2 text-balance">
              Des projets livrés,<br />pas seulement promis.
            </h2>
            <p className="text-base md:text-[17px] leading-[1.55] text-ink-3 m-0 max-w-[560px]">
              Une sélection de missions récentes — chantiers, importations, approvisionnements — pour vous donner une idée concrète de ce que nous savons faire.
            </p>
          </div>
          <Link
            to="/realisations"
        ...
        >
          {featured.map((p, i) => <ProjectCard key={p.slug} p={p} i={i} />)}
        </motion.div>
      </div>
    </section>
  );
